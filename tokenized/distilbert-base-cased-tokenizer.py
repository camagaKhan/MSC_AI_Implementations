...
torch.save(train_dict, './tokenized/DistilBERT-BASE-CASED/train.pth')
torch.save(test_dict, './tokenized/DistilBERT-BASE-CASED/test.pth')
torch.save(validation_dict, './tokenized/DistilBERT-BASE-CASED/validation.pth')
