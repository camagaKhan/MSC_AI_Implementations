...
torch.save(train_dict, './tokenized/HateBert/train.pth')
torch.save(test_dict, './tokenized/HateBert/test.pth')
torch.save(validation_dict, './tokenized/HateBert/validation.pth')
