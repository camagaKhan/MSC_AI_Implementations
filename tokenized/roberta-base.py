...
torch.save(train_dict, './tokenized/roberta-base/train.pth')
torch.save(test_dict, './tokenized/roberta-base/test.pth')
torch.save(validation_dict, './tokenized/roberta-base/validation.pth')
