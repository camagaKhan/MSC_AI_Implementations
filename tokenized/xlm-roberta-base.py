...
torch.save(train_dict, './tokenized/xlm-roberta-base/train.pth')
torch.save(test_dict, './tokenized/xlm-roberta-base/test.pth')
torch.save(validation_dict, './tokenized/xlm-roberta-base/validation.pth')
