...
torch.save(train_dict, './tokenized/distilbert-base-uncased/train.pth')
torch.save(test_dict, './tokenized/distilbert-base-uncased/test.pth')
torch.save(validation_dict, './tokenized/distilbert-base-uncased/validation.pth')
