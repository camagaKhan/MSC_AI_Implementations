...
torch.save(train_dict, './tokenized/BERT-BASE-CASED/train.pth')
torch.save(test_dict, './tokenized/BERT-BASE-CASED/test.pth')
torch.save(validation_dict, './tokenized/BERT-BASE-CASED/validation.pth')
