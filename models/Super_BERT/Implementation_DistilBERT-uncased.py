...
training_samples = torch.load('././tokenized/distilbert-base-uncased/train.pth') # Call the tokenized dataset
...
############################################## validation ########################################################################
validation_samples = torch.load('././tokenized/distilbert-base-uncased/validation.pth') # Call the tokenized dataset
...
# read this: https://rmoklesur.medium.com/temperature-scaling-fine-tuning-deep-learning-models-for-improved-calibration-730f306e6854
########################################################### Metrics ############################################################################
...
checkpoint_callback = ModelCheckpoint(
    ...
    dirpath='./saved/distilbert-base-uncased',  # Directory to save the checkpoints
    filename='distilbert-FL-uncased-{epoch:02d}-{val_loss:.6f}',  # Filename pattern
