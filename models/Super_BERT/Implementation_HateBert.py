...
training_samples = torch.load('././tokenized/HateBert/train.pth') # Call the tokenized dataset
...
############################################## validation ########################################################################
validation_samples = torch.load('././tokenized/HateBert/validation.pth') # Call the tokenized dataset
...
checkpoint_callback = ModelCheckpoint(
    ...
    dirpath='./saved/hateBERT',  # Directory to save the checkpoints
    filename='hatebert-{epoch:02d}-{val_loss:.4f}',  # Filename pattern
