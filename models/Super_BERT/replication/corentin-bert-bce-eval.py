...
METRIC_FILE_PATH = '././Metrics_results/BERT-Base-Uncased/bert_uncased-test.metric.json'
...
model = torch.load("././saved/bert-base-uncased/bert-base-uncased-corentin.model")
