...
METRIC_FILE_PATH = '././Metrics_results/BERT-Base-Uncased/bert_uncased.metric.json'
MODEL_FILE_PATH = f'././saved/bert-base-uncased/bert-base-uncased-corentin.model'
...
train_df, validation_df = train_test_split(all_data, test_size=0.1, random_state=42)
del all_data
...
def train_epoch(epoch_id=None):
    ...
    for batch_id, batch in enumerate(progress):
        if batch_id != 0 and batch_id % 3_000 == 0:
