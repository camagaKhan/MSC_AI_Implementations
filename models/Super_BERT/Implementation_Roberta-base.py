...
training_samples = torch.load('././tokenized/roberta-base/train.pth') # Call the tokenized dataset
...
############################################## validation ########################################################################
validation_samples = torch.load('././tokenized/roberta-base/validation.pth') # Call the tokenized dataset
...
checkpoint_callback = ModelCheckpoint(
    ...
    dirpath='./saved/roberta-base',  # Directory to save the checkpoints
    filename='roberta-base-{epoch:02d}-{val_loss:.4f}',  # Filename pattern
