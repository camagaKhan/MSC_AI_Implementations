...
try:
    ...
    for epoch in progress:
       ...
       torch.save(transformer, f'././././saved/hateBERT/HateBERT_xavier_{MAX_LENGTH}_{loss_fn_name}_{epoch}_6lbls_jigsaw_{LEARNING_RATE}.model')
       
       torch.cuda.empty_cache() # always empty cache before you start a new epoch
    
    with open(f'././././Metrics_results/HateBert/training/HateBERT_xavier_{MAX_LENGTH}_{loss_fn_name}_jigsaw_6lbls_training_{LEARNING_RATE}.pkl', 'wb') as f:
        pickle.dump(training_log, f)

    with open(f'././././Metrics_results/HateBert/validation/HateBERT_xavier_{MAX_LENGTH}_{loss_fn_name}_jigsaw_6lbls_validation_{LEARNING_RATE}.pkl', 'wb') as f:
