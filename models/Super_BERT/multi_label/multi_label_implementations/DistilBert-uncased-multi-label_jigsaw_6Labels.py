...
try:
    ...
    for epoch in progress:
       ...
       torch.save(transformer, f'././././saved/distilbert-base-uncased/DistilBERT_jigsaw_{loss_fn_name}_{epoch}_6lbls_jigsaw.model')
       
       torch.cuda.empty_cache() # always empty cache before you start a new epoch
    
    with open(f'././././Metrics_results/distilbert-base-uncased/training/DistilBERT-ML-uncased-jigsaw_6lbls_{loss_fn_name}__training.pkl', 'wb') as f:
        pickle.dump(training_log, f)

    with open(f'././././Metrics_results/distilbert-base-uncased/validation/DistilBERT-ML-uncased-jigsaw_6lbls_{loss_fn_name}__validation.pkl', 'wb') as f:
