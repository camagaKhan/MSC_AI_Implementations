...
training_pd, validation_pd = pd.read_csv('././Data/wiki_corpus.training.csv'), pd.read_csv('././Data/wiki_corpus.validation.csv')
...
THRESHOLD, num_labels = .7, NUM_LABELS # 8 was ok
...
try:
    ...
    for epoch in progress:
       ...
       torch.save(transformer, f'././././saved/bert-base-cased/BERT_wiki_{epoch}_wiki.model')
       
       torch.cuda.empty_cache() # always empty cache before you start a new epoch
    
    with open('././././Metrics_results/BERT-Base-cased/training/BERT-Cased-wiki_training.pkl', 'wb') as f:
        pickle.dump(training_log, f)

    with open('././././Metrics_results/BERT-Base-cased/validation/BERT-Cased-wiki_validation.pkl', 'wb') as f:
