...
try:
    ...
    for epoch in progress:
       ...
       torch.save(transformer, f'././././saved/bert-base-uncased/BERT_jigsaw_{epoch}_jigsaw.model')
       
       torch.cuda.empty_cache() # always empty cache before you start a new epoch
    
    with open('././././Metrics_results/BERT-Base-Uncased/training/BERT-uncased-jigsaw_training.pkl', 'wb') as f:
        pickle.dump(training_log, f)

    with open('././././Metrics_results/BERT-Base-Uncased/validation/BERT-uncased-jigsaw_validation.pkl', 'wb') as f:
