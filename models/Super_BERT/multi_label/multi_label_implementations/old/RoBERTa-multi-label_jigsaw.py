...
try:
    ...
    for epoch in progress:
       ...
       torch.save(transformer, f'././././saved/roberta-base/BERT_jigsaw_{epoch}_jigsaw.model')
       
       torch.cuda.empty_cache() # always empty cache before you start a new epoch
    
    with open('././././Metrics_results/roberta-base/training/roberta-jigsaw_training.pkl', 'wb') as f:
        pickle.dump(training_log, f)

    with open('././././Metrics_results/roberta-base/validation/roberta-jigsaw_validation.pkl', 'wb') as f:
