...
try:
    ...
    for epoch in progress:
       ...
       torch.save(transformer, f'././././saved/hateBERT/BERT_jigsaw_{epoch}_jigsaw.model')
       
       torch.cuda.empty_cache() # always empty cache before you start a new epoch
    
    with open('././././Metrics_results/HateBert/training/HateBERT-jigsaw_training.pkl', 'wb') as f:
        pickle.dump(training_log, f)

    with open('././././Metrics_results/HateBert/validation/HateBERT-jigsaw_validation.pkl', 'wb') as f:
