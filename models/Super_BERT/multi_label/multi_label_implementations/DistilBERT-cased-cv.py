...
try:
    ...
    with open(f'././././Metrics_results/distilbert-base-cased/training/DistilBERT-kfold-FocalLoss_{BATCH}_training_{LEARNING_RATE}.pkl', 'wb') as f:
        pickle.dump(training_log, f)

    with open(f'././././Metrics_results/distilbert-base-cased/validation/DistilBERT-kfold-FocalLoss_{BATCH}_validation_{LEARNING_RATE}.pkl', 'wb') as f:
