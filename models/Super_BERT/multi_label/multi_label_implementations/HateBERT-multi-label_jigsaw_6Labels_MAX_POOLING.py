...
folder_name, file_name = 'hateBERT',  'HateBERT_xavier_150_FL_3_MAX_POOLING__6lbls_jigsaw_2e-05' #'DistilBERT_jigsaw_FL_3_6lbls_jigsaw'
...
with torch.no_grad():
    ...
    with open(f'././././Metrics_results/HateBert/test/HateBERT-ML-base-jigsaw_6lbls_{'FL'}_MAX_POOLING_training.pkl', 'wb') as f:
