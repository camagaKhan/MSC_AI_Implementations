...
from Model_Skeleton_MultiLabel import HateCrimeDataset, LightHateCrimeModel, HateCrimeDataModule
...
no_samples=training_samples_len, # calculating weights =]
    max_lr=3e-5, 
    positives=positives,
    negatives=negatives,
...
checkpoint_callback = ModelCheckpoint(
    ...
    filename='distilbert-cased-multi-label-{epoch:02d}-{val_loss:.2f}',  # Filename pattern
