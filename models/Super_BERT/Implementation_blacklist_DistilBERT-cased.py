...
training_dataset = BinaryHateCrimeDataset(training_samples, model_name=MODEL_NAME, max_length=MAX_LENGTH, has_labels=True, label_name='blacklist') # convert it to a pytorch dataset
...
validation_dataset = BinaryHateCrimeDataset(validation_samples, model_name=MODEL_NAME, max_length=MAX_LENGTH, has_labels=True, label_name='blacklist') # convert it to a pytorch dataset
...
checkpoint_callback = ModelCheckpoint(
    ...
    filename='blacklist-distilbert-FL-{epoch:02d}-{val_loss:.6f}',  # Filename pattern
