...
validation_samples = torch.load('././tokenized/distilbert-base-cased/validation.pth') # Call the tokenized dataset
...
folder_name, file_name = 'distilbert-base-cased',  'distilbert-FL-cased-epoch=00-val_loss=0.013536'
