...
folder_name, file_name = 'distilbert-base-uncased',  'DistilBERT_jigsaw_FL_1_MAX_POOLING_6lbls_jigsaw' #'DistilBERT_jigsaw_FL_3_6lbls_jigsaw'
...
with torch.no_grad():
    ...
    with open(f'././././Metrics_results/distilbert-base-uncased/test/DistilBERT-ML-uncased-jigsaw_6lbls_{'FL'}_MAX_POOLING_training.pkl', 'wb') as f:
