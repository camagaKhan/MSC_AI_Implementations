...
folder_name, file_name = 'hateBERT',  'HateBERT_augmented_128_FL_3_6lbls_jigsaw_2e-05'
...
with torch.no_grad():
    ...
    with open(f'././././Metrics_results/HateBert/test/HateBert-ML-jigsaw_6lbls_{'FL'}_{MAX_LENGTH}_augmented_testing.pkl', 'wb') as f:
