...
folder_name, file_name = 'roberta-base',  'roberta-base_kaiming_128_FL_3_6lbls_MAX_POOLING_jigsaw_2e-05' #'DistilBERT_jigsaw_FL_3_6lbls_jigsaw'
...
with torch.no_grad():
    ...
    with open(f'././././Metrics_results/roberta-base/test/Roberta-ML-base-jigsaw_6lbls_{'FL'}_MAX_POOLING_training.pkl', 'wb') as f:
