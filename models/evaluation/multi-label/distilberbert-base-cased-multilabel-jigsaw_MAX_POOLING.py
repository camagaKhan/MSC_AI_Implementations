...
folder_name, file_name = 'distilbert-base-cased',  'DistilBERT_128_jigsaw_FL_3_6lbls_MAX_POOLING_jigsaw' #'DistilBERT_jigsaw_FL_3_6lbls_jigsaw'
...
with torch.no_grad():
    ...
    with open(f'././././Metrics_results/distilbert-base-cased/test/DistilBERT-ML-Cased-jigsaw_6lbls_{'FL'}_MAX_POOLING_training.pkl', 'wb') as f:
