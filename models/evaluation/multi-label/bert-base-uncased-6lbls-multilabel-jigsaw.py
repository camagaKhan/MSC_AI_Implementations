...
folder_name, file_name = 'bert-base-uncased',  'BERT_uncased_jigsaw_128_FL_3_6lbls_jigsaw'
...
with torch.no_grad():
    ...
    with open(f'././././Metrics_results/BERT-Base-Uncased/test/BERT-ML-Uncased-jigsaw_6lbls_{'FL'}_{MAX_LENGTH}_CECE_testing.pkl', 'wb') as f:
