...
test_samples = torch.load('././tokenized/roberta-base/test.pth') # Call the tokenized dataset
...
folder_name, file_name = 'roberta-base',  'roberta-base-epoch=02-val_loss=0.0146'
...
with open('././Metrics_results/roberta-base/test/roberta-binary-FocalLoss_test.pkl', 'wb') as f:
