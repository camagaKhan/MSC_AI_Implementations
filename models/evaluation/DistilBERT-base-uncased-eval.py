...
test_samples = torch.load('././tokenized/distilbert-base-uncased/test.pth') # Call the tokenized dataset
...
folder_name, file_name = 'distilbert-base-uncased',  'distilbert-FL-uncased-epoch=00-val_loss=0.013411'
...
with open('././Metrics_results/distilbert-base-uncased/test/DistilBERT-binary-FocalLoss_test.pkl', 'wb') as f:
