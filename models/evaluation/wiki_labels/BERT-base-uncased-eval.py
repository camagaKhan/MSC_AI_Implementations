...
test_samples = torch.load('./././tokenized/wiki_labels/bert-base-uncased/test_wiki.pth') # Call the tokenized dataset
...
folder_name, file_name = 'bert-base-uncased',  'bert-cased-epoch=02-val_loss=0.0126'
...
with open('./././Metrics_results/BERT-Base-Uncased/test/BERT-binary-wiki_test-FocalLoss_test.pkl', 'wb') as f:
