...
test_samples = torch.load('./././tokenized/wiki_labels/hateBert/test_wiki.pth') # Call the tokenized dataset
...
folder_name, file_name = 'hateBERT',  'hatebert-epoch=03-val_loss=0.0119'
...
with open('./././Metrics_results/HateBert/test/HateBERT-binary-wiki_labels-FocalLoss_test.pkl', 'wb') as f:
