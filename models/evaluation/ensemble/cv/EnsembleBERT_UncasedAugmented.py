...
models = []
for i in range(1, 6):
    checkpoint = f'BERT_augmented_FL_16_2_fold_{i}.model'
...
with open(f'././././Metrics_results/ensemble/bert_uncased-augmented-ML-Cased-jigsaw_6lbls_{'FL'}_ensemble_averaging_training.pkl', 'wb') as f:
